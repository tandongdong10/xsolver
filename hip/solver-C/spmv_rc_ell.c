...
void spmv_rcell(const int rows,const int cols,const TYPE* value,const int* index,const int width,\
                 const TYPE* x,TYPE* y)
{
   int r,c,br,bc;
   int br_size = rows / NUM_THREADS_ROW,bc_size = width / NUM_THREADS_COL;
